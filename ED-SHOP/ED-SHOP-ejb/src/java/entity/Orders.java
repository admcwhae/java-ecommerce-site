...
@NamedQueries({
    ...
    , @NamedQuery(name = "Orders.findByCastle", query = "SELECT o FROM Orders o WHERE o.castle = :castle")
    , @NamedQuery(name = "Orders.findByKingdom", query = "SELECT o FROM Orders o WHERE o.kingdom = :kingdom")
